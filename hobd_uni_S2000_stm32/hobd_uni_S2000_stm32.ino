...
//STM32 mini ('blue pill' maple mini clone)//        +------+=====+-----+//        |      | USB |     |//SS2   31|PB12  +-----+  GND|//SCK2  30|PB13           GND|//MISO2 29|PB14           3V3|//MOSI2 28|PB15           RST|//      27|PA8           PB11|0  RX3 SDA2 //TX1   26|PA9           PB10|1  TX3 SCL2//RX1   25|PA10           PB1|33//      24|PA11           PB0|3  A0//      23|PA12           PA7|4  A1 MOSI1//      20|PA15           PA6|5  A2 MISO1//      19|PB3            PA5|6  A3 SCK1//      18|PB4            PA4|7  A4 SS1//      17|PB5            PA3|8  A5 RX2//SCL1  16|PB6            PA2|9  A6 TX2//SDA1  15|PB7            PA1|10 A7//      32|PB8            PA0|11 A8//        |PB9           PC15|12//        |5V            PC14|13//        |GND           PC13|14//        |3V3           VBAT|//        |  []  []  []  []  |//        | 3V3 DIO DCLK GND |//        +------------------+
...
#define btSerial Serial1 //(10,11); // RX, TX
#define ecuSerial Serial2 //(12, 12);
...
uint8_t ADCL, ADCH, ADCSRA, ADSC;
#define bit_is_set(x,y) (x&y > 0)
#endif
...
void processBluetoothCommand(const char * btdata1, const uint8_t &command_length)
{
   ...
   else
   {
      ...
      switch (OBD2_Command)
      {
         ...
         case 0x0100:
         sprintf(btdata2, "41 00 BE 3E B0 11\r\n>");
         response = DATA;
         ...
         if (response == DATA)
         {
            ...
            sprintf(btdata2, "41 01 %02X 00 00 00\r\n>", a);
         }
         break;
         // freeze dtc / 00 61 ???
         case 0x0102:
         ...
         */
         ...
         //  sprintf(btdata2, "41 03 %02X 00\r\n>", a);
         // }
         response = ecuCommand(0x20, 0x05, 0x9a, 0x02, ecudata);
         if (response == DATA)
         {
            sprintf(btdata2, "41 03 %02X %02X\r\n>", ecudata[2], ecudata[3]);
         }
         break;
         ...
         sprintf(btdata2, "41 30 20 00 00 01\r\n>");
         break;
         ...
         if (response == DATA)
         {
            sprintf(btdata2, "60 FF 0A %02X\r\n>", ecudata[2]);
         }
         break;
         case 0x200B: // custom hobd mapping / flags
         //sprintf(btdata2, "60 0C AA\r\n>"); // 10101010 / test data
         response = ecuCommand(0x20, 0x05, 0x0B, 0x01, ecudata);
         if (response == DATA)
         {
            sprintf(btdata2, "60 FF 0B %02X\r\n>", ecudata[2]);
         }
         break;
   ...
   {
      case RESET:
      sprintf(btdata2, "Honda OBD v1.0\r\n>"); break;
      case OK:
      sprintf(btdata2, "OK\r\n>"); break;
      case DATA_ERROR:
      sprintf(btdata2, "DATA ERROR\r\n>"); break;
      case NO_DATA:
      sprintf(btdata2, "NO DATA\r\n>"); break;
